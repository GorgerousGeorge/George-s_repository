...
def test_get_mask_card_number(numbers_16_spases):
    assert get_mask_card_number(numbers_16_spases) == "7000 79** **** 6361"


def test_get_mask_card_number(numbers_16_int):
...
def test_get_mask_card_number(numbers_13):
...
def test_get_mask_account(numbers_20_spases):
    assert get_mask_account(numbers_20_spases) == "**1234"


def test_get_mask_account(numbers_20_int):
